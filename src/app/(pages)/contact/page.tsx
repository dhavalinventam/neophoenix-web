          ...
          <div className="container">
            <div className={styles.heroContent}>
              <h1 className={styles.heroTitle}>
                ...
                <span className={styles.heroTitleAccent}> Amazing</span>
                <span className={styles.heroTitleDot}>.</span>
              </h1>
              <p className={styles.heroSubtitle}>
                Ready to transform your ideas into reality? We're here to help you create something extraordinary.
              </p>
            </div>
          </div>
        </div>
                  ...
                  <div className={styles.contactMethods}>
                    <div className={styles.contactMethod}>
                      ...
                      <div className={styles.methodContent}>
                        ...
                        <p className={styles.methodText}>67 Wisteria Way Croydon South VIC 3136 AU</p>
                      </div>
                    </div>
                    ...
                    <div className={styles.contactMethod}>
                      ...
                      <div className={styles.methodContent}>
                        ...
                        <p className={styles.methodText}>(+995) 555-55-55-55</p>
              ...
              <div className="col-lg-8">
                <div className={styles.formSection}>
                  <div className={styles.formHeader}>
                    ...
                    <p className={styles.formSubtitle}>Tell us about your project and we'll get back to you</p>
                  </div>
