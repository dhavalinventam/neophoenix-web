    ...
    <footer className={styles.footer}>
      ...
      <div className="container">
        ...
        <div className={`row ${styles.mainContent}`}>
          {/* Company Logo and Description - Left Side */}
          ...
          {/* Right Side - Menu, Social Icons, and Email Box Side by Side */}
          <div className="col-lg-8 col-md-12 mb-3">
            <div className={styles.rightSideContent}>
              <div className="row">
                ...
                {/* Social Icons and Email Box */}
                <div className="col-lg-6 col-md-12 mb-3">
                  <div className={styles.socialEmailSection}>
                    <div className={styles.emailSection}>
                      <h6 className={styles.emailTitle}>Stay Updated</h6>
