      ...
      icon: (
        ...
        >
          ...
          <path
            ...
            fill="currentColor"
          />
          <path d="M22 12H24V14H22V12ZM22 16H24V18H22V16ZM22 20H24V22H22V20Z" fill="currentColor" />
        </svg>
      ),
    },
    {
      ...
      icon: (
        ...
        >
          ...
          <path
            ...
            fill="currentColor"
          />
          <path d="M12 22H20V24H12V22ZM12 26H16V28H12V26Z" fill="currentColor" />
        </svg>
      ),
    },
    {
      ...
      icon: (
        ...
        >
          <path
            ...
            fill="currentColor"
          />
          <path d="M8 8H12V12H8V8ZM14 8H18V16H14V8ZM20 8H24V20H20V8Z" fill="currentColor" />
          <path d="M8 14H12V20H8V14ZM14 18H18V20H14V18ZM20 22H24V24H20V22Z" fill="currentColor" />
        </svg>
      ),
    },
  ];
